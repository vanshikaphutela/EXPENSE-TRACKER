...
const Analytics = ({ transactions }) => {
  ...
  const totalIncomeTransactionsAmount = totalIncomeTransactions.reduce((acc, transaction) => acc + transaction.amount, 0);
  const totalExpenseTransactions = transactions.filter(
    (item) => item.transactionType === "expense"
  );
  const totalExpenseTransactionsAmount = totalExpenseTransactions.reduce((acc, transaction) => acc + transaction.amount, 0);
  ...
  const totalTurnOver = totalIncomeTransactionsAmount - totalExpenseTransactionsAmount;
  ...
  const TurnOverIncomePercent = (totalTurnOverIncome / (totalIncomeTransactionsAmount + totalExpenseTransactionsAmount)) * 100;
  const TurnOverExpensePercent = (totalTurnOverExpense / (totalIncomeTransactionsAmount + totalExpenseTransactionsAmount)) * 100;
